...
- [`/baseapp`](https://github.com/reapchain/cosmos-sdk/tree/master/baseapp)
- [`/crypto`](https://github.com/reapchain/cosmos-sdk/tree/master/crypto)
- [`/types`](https://github.com/reapchain/cosmos-sdk/tree/master/types)
- [`/store`](https://github.com/reapchain/cosmos-sdk/tree/master/store)

### Modules

- [`x/auth`](https://github.com/reapchain/cosmos-sdk/tree/master/x/auth)
- [`x/bank`](https://github.com/reapchain/cosmos-sdk/tree/master/x/bank)
- [`x/capability`](https://github.com/reapchain/cosmos-sdk/tree/master/x/capability)
- [`x/staking`](https://github.com/reapchain/cosmos-sdk/tree/master/x/staking)
- [`x/slashing`](https://github.com/reapchain/cosmos-sdk/tree/master/x/slashing)
- [`x/evidence`](https://github.com/reapchain/cosmos-sdk/tree/master/x/evidence)
- [`x/distribution`](https://github.com/reapchain/cosmos-sdk/tree/master/x/distribution)
- [`x/ibc`](https://github.com/reapchain/cosmos-sdk/tree/master/x/ibc)
- [`x/ibc-transfer`](https://github.com/reapchain/cosmos-sdk/tree/master/x/ibc-transfer)
- [`x/mint`](https://github.com/reapchain/cosmos-sdk/tree/master/x/mint)
...
also recommend you to read the [specification](https://github.com/reapchain/cosmos-sdk/blob/master/docs/building-modules/README.md) of each module before digging into
the code.
...
- Tx signature verification (see [`x/auth/ante`](https://github.com/reapchain/cosmos-sdk/tree/master/x/auth/ante))
...
1. Patches are prepared in private repositories for eligible releases of Cosmos SDK. See [Stable Releases](https://github.com/reapchain/cosmos-sdk/blob/master/STABLE_RELEASES.md) for a list of eligible releases.
