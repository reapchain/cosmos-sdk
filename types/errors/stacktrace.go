...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/reapchain/cosmos-sdk/types/errors.Wrap",
		"github.com/reapchain/cosmos-sdk/types/errors.Wrapf",
		"github.com/reapchain/cosmos-sdk/types/errors.WithType",
