...
- Duplicates `n` headers data in Tendermint & the application (additional disk usage) - in the long term, an approach such as [this](https://github.com/reapchain/reapchain-core/issues/4210) might be preferable.
