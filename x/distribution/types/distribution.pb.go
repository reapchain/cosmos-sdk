...
type Params struct {
	...
	WithdrawRewardEnabled bool                                      `protobuf:"varint,5,opt,name=withdraw_reward_enabled,json=withdrawRewardEnabled,proto3" json:"withdraw_reward_enabled,omitempty" yaml:"withdraw_reward_enabled"`
}
...
func (m *Params) GetWithdrawRewardEnabled() bool {
	if m != nil {
		return m.WithdrawRewardEnabled
	}
	return false
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.WithdrawRewardEnabled != that1.WithdrawRewardEnabled {
		return false
	}
	return true
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithdrawRewardEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WithdrawRewardEnabled = bool(v != 0)
		default:
			iNdEx = preIndex
