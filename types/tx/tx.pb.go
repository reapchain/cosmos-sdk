...
import (
	...
	signing "github.com/reapchain/cosmos-sdk/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Fee struct {
	...
	Amount github_com_reapchain_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/reapchain/cosmos-sdk/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_reapchain_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
