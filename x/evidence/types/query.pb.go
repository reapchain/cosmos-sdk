...
type QueryEvidenceRequest struct {
	...
	EvidenceHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=evidence_hash,json=evidenceHash,proto3,casttype=github.com/reapchain/reapchain-core/libs/bytes.HexBytes" json:"evidence_hash,omitempty"`
}
