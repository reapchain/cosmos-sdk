...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_reapchain_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
	...
	ValidatorType     string                                    `protobuf:"bytes,8,opt,name=validator_type,json=validatorType,proto3" json:"validator_type,omitempty" yaml:"validator_type"`
}
...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_reapchain_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
...
func (m *MsgCreateValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ValidatorType) > 0 {
		i -= len(m.ValidatorType)
		copy(dAtA[i:], m.ValidatorType)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ValidatorType)))
		i--
		dAtA[i] = 0x42
	}
	{
...
func (m *MsgCreateValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.ValidatorType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
