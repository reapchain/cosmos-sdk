...
var (
	...
	ErrWithdrawRewardDisabled     = sdkerrors.Register(ModuleName, 14, "set withdraw reward disabled")
	ErrWithdrawCommissionDisabled = sdkerrors.Register(ModuleName, 15, "set withdraw commission disabled")
)
