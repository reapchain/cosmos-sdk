...
func TestQueryDelegation(t *testing.T) {
	...
	val1 := teststaking.NewValidator(t, addrVal1, pk1, types.ValidatorTypeStanding)
	app.StakingKeeper.SetValidator(ctx, val1)
	app.StakingKeeper.SetValidatorByPowerIndex(ctx, val1)

	val2 := teststaking.NewValidator(t, addrVal2, pk2, types.ValidatorTypeStanding)
...
func TestQueryValidatorDelegations_Pagination(t *testing.T) {
	...
	val1 := teststaking.NewValidator(t, valAddress, pubKeys[0], types.ValidatorTypeStanding)
	app.StakingKeeper.SetValidator(ctx, val1)
	app.StakingKeeper.SetValidatorByPowerIndex(ctx, val1)
...
func TestQueryRedelegations(t *testing.T) {
	...
	// Create Validators and Delegation
	val1 := teststaking.NewValidator(t, addrVal1, PKs[0], types.ValidatorTypeStanding)
	val2 := teststaking.NewValidator(t, addrVal2, PKs[1], types.ValidatorTypeStanding)
	app.StakingKeeper.SetValidator(ctx, val1)
	app.StakingKeeper.SetValidator(ctx, val2)
